...
- **Service Mesh Sidecarless (Cilium Mesh Enterprise):** Para tráfico interno East-West (7.5B requests/mes), eliminando hair-pinning mediante comunicación directa pod-a-pod
